...
Final-year Information Technology student at the University of Energy and Natural
Resources (UENR), Ghana, graduating 2026. This site covers my work in Flutter mobile
development and web development, alongside cybersecurity fundamentals I'm actively
building toward a blue team / SOC analyst path.

## Featured Projects

- **LeafCare** — AI-powered Flutter Android app for tomato leaf disease detection.
  Built with a 5-member team; custom CNN on the PlantVillage dataset, on-device
  TFLite inference, weather/GPS-based outbreak risk, and a bilingual (English/Twi)
  chatbot. Final-year capstone project.
...
Available for freelance projects (Fiverr/Upwork) and full-time opportunities.
